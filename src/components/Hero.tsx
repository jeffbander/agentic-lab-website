      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-8">
            Turn clinical insights into HIPAA-compliant applications. AI-assisted development achieving 83.8% code acceptance and $50k-200k annual savings per project.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.a
              href="#projects"
              onClick={() => trackCTAClick('Hero', 'See Live Projects & ROI Calculator')}
            ...
            >
              See Live Projects & ROI Calculator →
            </motion.a>
            <motion.a
              href="#contact"
