...
{TEMPLATE}
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 px-6 bg-gradient-to-r from-sinai-cyan-600 to-sinai-magenta-600 text-black font-semibold rounded-lg hover:from-sinai-cyan-700 hover:to-sinai-magenta-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
          style={{ color: '#000000' }}
        >
          {isGenerating ? (
            <>
              <svg className="animate-spin h-5 w-5 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={{ color: '#000000' }}>
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <span style={{ color: '#000000' }}>Generating Script with GPT-4...</span>
            </>
          ) : (
            <span style={{ color: '#000000' }}>Preview 12s Script →</span>
          )}
        </button>
      </div>
    </motion.div>
